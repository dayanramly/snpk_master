            ...
            for antecedent in itertools.combinations(itemset, i):
                ...
                if antecedent in patterns:
                    ...
                    if consequent in patterns:
                        consequent_item = patterns[consequent]
                        benchmark_confidence = float(consequent_item) / transactions
                        lift_ratio = confidence / benchmark_confidence

                        if confidence >= confidence_threshold:
                            rules[antecedent] = (consequent, confidence, lift_ratio)
